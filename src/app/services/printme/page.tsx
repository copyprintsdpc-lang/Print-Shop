...
export default function PrintMePage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mt-3 text-gray-600">Our simplified print options allow you to print what you need when you need it.</p>
            </div>
      ...
      <section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <p className="text-sm text-gray-600 mb-4">Print conveniently from wherever suits you with our 3 easy ways to print.</p>
