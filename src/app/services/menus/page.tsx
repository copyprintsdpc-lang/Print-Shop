      ...
      <section className="border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Menus</h1>
            <p className="text-lg font-semibold text-gray-900 mt-2">{formatINR(0.99)}*</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-sm text-gray-700">
            <div>
              ...
              <p>Hand them out or tuck them in with takeout—custom menus make your offerings shine. Available in multiple finishes and sizes, including 8.5×11” (standard, deluxe, premium), 8.5×14” standard, and 11×17” (standard, deluxe) for same‑day service.</p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Product Dimensions</h3>
              <ul className="list-disc list-inside space-y-1">
                <li>Sizes: 8.5” × 11”, 8.5” × 14”, 11” × 17”</li>
                <li>Orientation: Horizontal or Vertical</li>
                <li>Sides: 1‑Sided or 2‑Sided</li>
                <li>Finishes: Standard, Deluxe, Premium (select sizes)</li>
              </ul>
            </div>
            <div>
