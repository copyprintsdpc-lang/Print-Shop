            ...
            <div className="mt-4 grid grid-cols-2 gap-4 text-sm text-gray-700">
              <div>
                ...
                <div className="flex gap-2 mt-1">
                  <span className="inline-block border rounded px-3 py-1 bg-white">4” × 6”</span>
                  <span className="inline-block border rounded px-3 py-1 bg-white">4” × 8”</span>
                  <span className="inline-block border rounded px-3 py-1 bg-white">5” × 7”</span>
                </div>
              </div>
              <div>
