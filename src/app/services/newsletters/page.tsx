      ...
      <section className="border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div>
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Newsletters</h1>
            <p className="text-lg font-semibold text-gray-900 mt-2">{formatINR(0.56)}*</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-sm text-gray-700">
            <div>
              ...
              <p>Keep everyone in the know with custom newsletters—perfect for updates, promos, or seasonal cheer. Matte or glossy? Your call. Same‑day orders print with a ¼” white border on all sides. Fast turnaround, great prices.</p>
            </div>
            <div>
